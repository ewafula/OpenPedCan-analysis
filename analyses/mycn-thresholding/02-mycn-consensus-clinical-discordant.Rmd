...
mycn_diff_df <- read_tsv("results/mycn_consensus_vs_clinical_diff_status.tsv")
...
cnvkit_mycn_diff_df <- read_tsv("results/cnvkit_mycn_consensus_vs_clinical_diff_status.tsv")
```
